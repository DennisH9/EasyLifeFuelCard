 ...
 * @time 下午2:46:35
 */
public class SettingCommoncationGprsFragment extends BaseSettingFragment{
...
//	@ViewInject(R.id.key_board_number)
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mFragmentView = inflater.inflate(R.layout.setting_communication_gprs_fragment,
				null);
	...
	protected void initData() {	
		...
		setTitle(R.string.connect_type_gprs);
		...
		scvConnectMode.setParamData(R.string.connect_mode, R.string.connect_mode_long, "1", 
				R.string.connect_mode_short, "0", ParamsConst.PARAMS_KEY_GPRS_MODE);
		...
		sevAccessNumber.setParamData(ParamsConst.PARAMS_KEY_GPRS_ACCESS_NUMBER);
		sivIp1.setParamData(ParamsConst.PARAMS_KEY_GPRS_SERVERIP1, keyboardNumber);
		sevPort1.setParamData(ParamsConst.PARAMS_KEY_GPRS_PORT1);
		sivIp2.setParamData(ParamsConst.PARAMS_KEY_GPRS_SERVERIP2, keyboardNumber);
		sevPort2.setParamData(ParamsConst.PARAMS_KEY_GPRS_PORT2);
		sevUserName.setParamData(ParamsConst.PARAMS_KEY_GPRS_USERNAME);
		sevPassword.setParamData(ParamsConst.PARAMS_KEY_GPRS_PWD);

		sevTpdu.setKeyboardNumber(keyboardNumber);
		sevTpdu.setParamData(ParamsConst.PARAMS_KEY_GPRS_TPDU);
