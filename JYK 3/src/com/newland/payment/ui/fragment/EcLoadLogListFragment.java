...
public class EcLoadLogListFragment extends BaseFragment{
...
//	@ViewInject(R.id.slid_prompt)
	...
	private List<EcLoadBean> beans;
	private FragmentPagerAdapter ecLoadLogListAdapter;
	private CommonBean<List<EcLoadBean>> bean;
	
	public EcLoadLogListFragment(long timeOut) {
		super(timeOut);
	}
	public static EcLoadLogListFragment newInstance(CommonBean<List<EcLoadBean>> bean){
		EcLoadLogListFragment fragment = new EcLoadLogListFragment(bean.getTimeOut());
		fragment.bean = bean;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			mFragmentView = inflater.inflate(R.layout.ec_load_log_list_fragment,
					null);
	...
	protected void initData() {
		...
		new CommonThread(new ThreadCallBack() {
			...
			@Override
			public void onMain() {
				viewPager.setAdapter(ecLoadLogListAdapter);
				ecLoadLogListAdapter.notifyDataSetChanged();
				if (ecLoadLogListAdapter.getCount() == 0) {
			...
			public void onBackGround() {
				ecLoadLogListAdapter = new FragmentPagerAdapter(getChildFragmentManager()) {
					...
					public Fragment getItem(int arg0) {
						...
						return new EcLoadLogItemFragment(beans.get(arg0), bean);
					}
				};
...
//		R.id.txt_next_page})
	...
	protected void initClickEvent(View view) {
		...
		if (i == R.id.txt_back_page) {
			...
			if (viewPager.getCurrentItem() == ecLoadLogListAdapter.getCount() - 1) {
