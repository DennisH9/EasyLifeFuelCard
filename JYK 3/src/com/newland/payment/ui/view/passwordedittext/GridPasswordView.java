package com.newland.payment.ui.view.passwordedittext;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private static final String DEFAULT_LINECOLOR = "#aa888888";
    private static final String DEFAULT_GRIDCOLOR = "#ffffffff";
...
//    }
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textSize != -1) {
            this.mTextSize = DisplayUtils.px2sp(context, textSize);
        }

        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, DisplayUtils.dip2px(getContext(), 1));
        mLineColor = ta.getColor(R.styleable.gridPasswordView_gpvLineColor, Color.parseColor(DEFAULT_LINECOLOR));
        mGridColor = ta.getColor(R.styleable.gridPasswordView_gpvGridColor, Color.parseColor(DEFAULT_GRIDCOLOR));
    ...
    public void setPassword(String password) {
    	if (password.length() > DEFAULT_PASSWORDLENGTH) {
    		return;
    	}
        clearPassword();
