 ...
 */
public class KeyboardPassword extends FrameLayout {
	...
	public KeyboardPassword(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public KeyboardPassword(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void initData() {
		View view = LayoutInflater.from(context).inflate(
				R.layout.keyboard_password, this, true);
		ViewUtils.inject(this, view);
	}


//	@OnClick({ R.id.iv_1, R.id.iv_2, R.id.iv_3, R.id.iv_4, R.id.iv_5,
//			R.id.iv_6, R.id.iv_7, R.id.iv_8, R.id.iv_9, R.id.iv_0,R.id.iv_backspeace })
